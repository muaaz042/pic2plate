...
const About = () => {
    return (
        <div id='about' className='flex flex-col justify-center gap-5 md:px-24 px-7 md:py-20 py-10'>
            ...
            <p>
                This platform is more than a recipe generator—it's your personal sous-chef, powered by artificial intelligence. Whether you're inspired by a dish you saw at a restaurant, or you want to explore new recipes from the comfort of your home, this tool makes it possible. <br />
                Embark on a culinary adventure today with your <span className='font-semibold'>AI-Powered Kitchen Assistant</span>—where technology meets taste!
            </p>
        </div>
    )
}
