    ...
    return (
        <div id='home' className="w-full">
            <div className="pt-8 pb-12 px-5">
                ...
                <p className="text-center font-normal text-2xl md:text-3xl lg:text-4xl">TRANSFORM YOUR PHOTOS INTO CUISINES</p>
            </div>
            <div className='bg-bg flex flex-col gap-8 py-8 px-4'>
                <p className="text-center font-bold lg:text-5xl md:text-4xl sm:text-2xl text-xl">Meet Your Personal AI-Powered Kitchen Assistant</p>
